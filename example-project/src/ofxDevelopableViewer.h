...
#include "ofxLibigl.h"
    ...
    {
    public:
        IGL_INLINE ofxDevelopableViewer();
        IGL_INLINE ofxDevelopableViewer(const Eigen::MatrixXd& V, const Eigen::MatrixXi& F);
        IGL_INLINE ofxDevelopableViewer(const Eigen::MatrixXd& V, const Eigen::MatrixXi& F, const Eigen::MatrixXi& E);
        
        IGL_INLINE void orig_set_mesh(const Eigen::MatrixXd& V, const Eigen::MatrixXi& F);
        IGL_INLINE void orig_set_mesh(const Eigen::MatrixXd& V, const Eigen::MatrixXi& F, const Eigen::MatrixXi& E);
        ...
        IGL_INLINE void orig_modify_V(const Eigen::MatrixXd& V);
        ...
        void (*predraw_callback)(ofxDevelopableViewer&, bool) = NULL;
        //Callback, called after internal keyboard handling is done. Arguments as in GLFW function
        void (*keyboard_callback)(ofxDevelopableViewer&, int, int, int, int) = NULL;
